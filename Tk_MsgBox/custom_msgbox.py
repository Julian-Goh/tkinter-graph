...
info_icon, info_src_img = _icon_load_resize(img_PATH = __location__, img_file = "info.png", img_width = 50, img_height = 50, copy_bool = True)
...
msg_box_info_icon = _pil_resize(info_src_img, img_scale = 0.15)

del ask_src_img, warn_src_img, err_src_img, info_src_img
...
class Warning_Msgbox(tk.Toplevel):
    def __init__(self, message, parent = None, title = 'Warning', width = None, height = None, font = 'Helvetica 11',
        ...
        warning_tk_icon = ImageTk.PhotoImage(warning_icon)
        msg_box_tk_icon = ImageTk.PhotoImage(msg_box_warn_icon)
        ...
        self.warning_tk_icon_canvas = tk.Canvas(self.icon_frame, width = 60, height = 60, highlightthickness = 0)
        self.warning_tk_icon_canvas['bg'] = default_bg
        self.warning_tk_icon_canvas.place(relx=0.5, rely=0.2, x=0, y=0, anchor = 'n')
        self.warning_tk_icon_canvas.update()
        self.warning_tk_icon_canvas.create_image(self.warning_tk_icon_canvas.winfo_width()/2, self.warning_tk_icon_canvas.winfo_height()/2, image=warning_tk_icon, anchor='center', tags='img')
        self.warning_tk_icon_canvas.image = warning_tk_icon

        self.warning_msg_var = tk.StringVar()
        self.warning_msg_label = WrappingLabel(self.msg_frame, font = self.msg_font, textvariable = self.warning_msg_var, anchor= message_anchor, justify = message_justify, bd = 0)
        self.warning_msg_label['bg'] = default_bg #blue'
        self.warning_msg_label.place(relx=0, rely = 0 , x= 0, y = 10, relwidth = 1, relheight = 1, width = -15, height = -20, anchor = 'nw')
        self.warning_msg_var.set(message)
...
class Info_Msgbox(tk.Toplevel):
    def __init__(self, message, parent = None, title = 'Info', width = None, height = None, font = 'Helvetica 11',
        message_anchor = 'nw', message_justify = tk.LEFT, parent_grab_set = False):
        if parent is None:
            tk.Toplevel.__init__(self)
        elif parent is not None:
        ...
        info_tk_icon = ImageTk.PhotoImage(info_icon)
        msg_box_tk_icon = ImageTk.PhotoImage(msg_box_info_icon)
        ...
        self.info_tk_icon_canvas = tk.Canvas(self.icon_frame, width = 60, height = 60, highlightthickness = 0)
        self.info_tk_icon_canvas['bg'] = default_bg
        self.info_tk_icon_canvas.place(relx=0.5, rely=0.2, x=0, y=0, anchor = 'n')
        self.info_tk_icon_canvas.update()
        self.info_tk_icon_canvas.create_image(self.info_tk_icon_canvas.winfo_width()/2, self.info_tk_icon_canvas.winfo_height()/2, image=info_tk_icon, anchor='center', tags='img')
        self.info_tk_icon_canvas.image = info_tk_icon

        self.info_msg_var = tk.StringVar()
        self.info_msg_label = WrappingLabel(self.msg_frame, font = self.msg_font, textvariable = self.info_msg_var, anchor= message_anchor, justify = message_justify, bd = 0)
        self.info_msg_label['bg'] = default_bg #'blue'
        self.info_msg_label.place(relx=0, rely = 0 , x= 0, y = 10, relwidth = 1, relheight = 1, width = -15, height = -20, anchor = 'nw')
        self.info_msg_var.set(message)
